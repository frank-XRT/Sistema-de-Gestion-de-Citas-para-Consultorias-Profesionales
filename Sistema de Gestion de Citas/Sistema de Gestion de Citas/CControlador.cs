...
namespace Sistema_de_Gestion_de_Citas
{
    public class CControlador
    {
        ...
        private void CargarAdministradorInicial()
        {
            ...
            {
                ListaClientes.Add(new CCliente(1, "Kevin", "22222222", "Masculino", "999111222", "kevin@gmail.com", "123"));
                ListaClientes.Add(new CCliente(2, "Guiso", "33333333", "Masculino", "999333444", "guiso@gmail.com", "123"));
                ListaClientes.Add(new CCliente(3, "Lucia", "44444444", "Femenino", "999555666", "lucia@gmail.com", "123"));
                ListaClientes.Add(new CCliente(4, "Maria", "55555555", "Femenino", "999777888", "maria@gmail.com", "123"));
            }
            
            if (ListaConsultores.Count == 0)
            {
                ListaConsultores.Add(new CConsultor(1, "Pedro Ramos", "66666666", "Masculino", "988111222", "pedro@gmail.com", "Legal", "Abogado especialista en derecho civil", "123", 100));
                ListaConsultores.Add(new CConsultor(2, "Ana Torres", "77777777", "Femenino", "988333444", "ana@gmail.com", "Contable", "Contadora especializada en impuestos", "123", 150));
                ListaConsultores.Add(new CConsultor(3, "Carlos Vega", "88888888", "Masculino", "988555666", "carlos@gmail.com", "Psicologia", "Psicologo clinico", "123", 120));
                ListaConsultores.Add(new CConsultor(4, "Rosa Flores", "99999999", "Femenino", "988777888", "rosa@gmail.com", "Tecnologico", "Consultora en sistemas", "123", 200));
                ListaConsultores.Add(new CConsultor(5, "Luis Pena", "12345678", "Masculino", "988999000", "luis@gmail.com", "Legal", "Asesor legal empresarial", "123", 100));
                ListaConsultores.Add(new CConsultor(6, "Maria Gutierrez", "87654321", "Femenino", "987654321", "maria.g@gmail.com", "Docencia", "Tutora y docente universitaria", "123", 80));
            }
